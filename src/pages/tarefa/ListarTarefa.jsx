...
const ListarTarefa = () => {
  ...
  const [openEditor, toggleOpenEditor] = useReducer(s => !s, false);
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
        ...
        <CardContent>
                ...
                {tarefas.map((tarefa, indice) => (
                    ...
                    >
                      ...
                      <TableCell align="right">
                        <Button variant="contained" color="success" onClick={() => handleEditar(tarefa.idTarefa)}><EditIcon fontSize="small" /></Button>            
                      </TableCell>
                      <TableCell align="right">
                        <Button variant="contained" color="error" onClick={() => handleDeletar(tarefa.idTarefa)}><DeleteIcon fontSize="small" /></Button>            
                      </TableCell>
                    </TableRow>
                ))}
            ...
            <Typography variant='h4' style={{marginTop: 20}}>Total tarefas: {tarefas.length}</Typography>
        </CardContent>
        <CardActions>
            <Button size="small" variant="contained" onClick={toggleOpen}>Criar Tarefa</Button>
    ...
    <div>
      ...
      >
        <div>
          <CriarTarefa handleClose={toggleOpen} tarefas={tarefas} setTarefas={setTarefas} />
        </div>
      </Modal>  
    </div>
    <div>
      ...
      >
        <div>
          <EditarTarefa handleCloseEditar={toggleOpenEditor} idTarefaSelecionada={idTarefaSelecionada} tarefas={tarefas} tarefa={tarefa} setTarefas={setTarefas} />
        </div>
      </Modal>  
    </div>
    </Card>
